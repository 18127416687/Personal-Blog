  ...
  <div class="admin-layout">
    <aside class="admin-sidebar">
      <div class="admin-nav">
        ...
        <RouterLink to="/my-photos" class="admin-nav-item"><i class="fa-regular fa-images"></i> 我的相册</RouterLink>
        <RouterLink to="/editor" class="admin-nav-item"><i class="fa-regular fa-pen-to-square"></i> 写文章</RouterLink>
        <RouterLink to="/my-articles" class="admin-nav-item active"><i class="fa-regular fa-newspaper"></i> 我的文章</RouterLink>
    ...
    <div class="admin-content">
      <div class="admin-card">
        <div class="my-articles-header">
          <h2><i class="fa-regular fa-newspaper"></i> 我的文章</h2>
          <RouterLink to="/editor" class="btn btn-primary"><i class="fa-solid fa-plus"></i> 写新文章</RouterLink>
        </div>

        <div class="filter-bar">
          <button class="filter-btn active" data-filter="all">全部</button>
          <button class="filter-btn" data-filter="public">公开</button>
          <button class="filter-btn" data-filter="private">私密</button>
          <button class="filter-btn" data-filter="scheduled">定时</button>
        </div>
...
onMounted(async () => {
  const inserted = await ensureScript("/static/js/my-articles.js");
  if (!inserted) runLegacyInit("__initMyArticlesPage");
});
</script>
